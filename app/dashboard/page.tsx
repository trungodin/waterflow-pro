        ...
        <section className="mb-10">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            ...
            <MetricCard
              ...
              subValue={Number(stats.SoNgayBQ) > 0 ? new Intl.NumberFormat('vi-VN', { minimumFractionDigits: 2, maximumFractionDigits: 2 }).format(Number(stats.SanLuong_Current) / Number(stats.SoNgayBQ)) : '0'}
              gradientColor="sky"
