...
export default function RevenueAnalysis() {
    ...
    const [selectedYearForDaily, setSelectedYearForDaily] = useState<number | null>(null)
                    ...
                    <div className="bg-white p-4 border border-gray-200 rounded-lg h-[400px]">
                        <ResponsiveContainer width="100%" height="100%">
                            <ComposedChart data={yearlyData} margin={{ top: 20, right: 20, bottom: 20, left: 20 }}>
                                ...
                                <Legend />
                                <Bar dataKey="TongThucThu" name="Thực thu" stackId="a" fill="#82ca9d" />
                                <Bar dataKey="TonThu" name="Tồn thu" stackId="a" fill="#ff8042" />
                                <Line type="monotone" dataKey="TongDoanhThu" name="Chuẩn thu" stroke="#8884d8" strokeWidth={2} />
                            </ComposedChart>
                        </ResponsiveContainer>
                    </div>
                </div>
                            ...
                            <div className="bg-white p-4 border border-gray-200 rounded-lg h-[400px]">
                                ...
                                <ResponsiveContainer width="100%" height="100%">
                                    <BarChart data={monthlyData} margin={{ top: 20, right: 20, bottom: 20, left: 20 }}>
                                        ...
                                        <Tooltip content={<CustomTooltip />} />
                                        <Legend />
                                        <Bar dataKey="TongDoanhThuKy" name="Chuẩn thu" fill="#8884d8" />
                                        <Bar dataKey="TongThucThuThang" name="Thực thu" fill="#82ca9d" />
                                    </BarChart>
                                </ResponsiveContainer>
                            </div>
                        </div>
                            ...
                            <div className="bg-white p-4 border border-gray-200 rounded-lg h-[400px]">
                                ...
                                <ResponsiveContainer width="100%" height="100%">
                                    <LineChart data={dailyData} margin={{ top: 20, right: 20, bottom: 20, left: 20 }}>
                                        ...
                                        <Tooltip content={<CustomTooltip />} />
                                        <Legend />
                                        <Line type="monotone" dataKey="TongCongNgay" name="Doanh thu ngày" stroke="#0088FE" strokeWidth={2} dot={{ r: 4 }} />
                                    </LineChart>
                                </ResponsiveContainer>
                            </div>
                        </div>
